...
def test_off_path_windows_rg_miss_is_reprobed_then_success_is_cached(
    ...
    # This test specifically owns shell-based discovery. Native discovery
    # has separate real-backend tests and must not bypass the simulated PATH.
    monkeypatch.setenv('TOOLRUSH_SEARCH', '0')
